...
from api.v1.views import web_app_views
from models import storage
from models.city import City
from models.state import State


@web_app_views.route("/states/<state_id>/cities",
                 strict_slashes=False,
                 methods=["GET"])
@web_app_views.route("/cities/<city_id>", strict_slashes=False, methods=["GET"])
...
@web_app_views.route("/cities/<city_id>", strict_slashes=False, methods=["DELETE"])
...
@web_app_views.route("/cities/<city_id>", strict_slashes=False, methods=["PUT"])
