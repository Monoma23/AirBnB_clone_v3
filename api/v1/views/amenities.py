...
@web_app_views.route("/amenities/<amenity_id>",
                     strict_slashes=False,
                     methods=["GET"])
@web_app_views.route("/amenities", strict_slashes=False, methods=["GET"])
...
@web_app_views.route("/amenities", strict_slashes=False, methods=["POST"])
def create_amenity():
    """
    Create Amenity :
...
@web_app_views.route("/amenities/<amenity_id>", strict_slashes=False,
                     methods=["PUT"])
